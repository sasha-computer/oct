...
private let hotKeyLogger = OctLog.hotKey
...
public struct HotKeyProcessor {
    ...
    public static let doubleTapThreshold: TimeInterval = OctCoreConstants.doubleTapWindow
    ...
    public static let pressAndHoldCancelThreshold: TimeInterval = OctCoreConstants.pressAndHoldCancelWindow
    ...
    public init(hotkey: HotKey, useDoubleTapOnly: Bool = false, minimumKeyTime: TimeInterval = OctCoreConstants.defaultMinimumKeyTime) {
        self.hotkey = hotkey
